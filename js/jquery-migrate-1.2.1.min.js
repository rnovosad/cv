  ...
  (function(e, t, n) {
            ...
            !e.attrHooks[c] &&
              ...
              ((e.attrHooks[c] = {
                get: function(t, r) {
                  var a,
                    i = e.prop(t, r)
                  return i === !0 || ('boolean' != typeof i && (a = t.getAttributeNode(r)) && a.nodeValue !== !1)
                    ? r.toLowerCase()
                    : n
                },
                set: function(t, n, r) {
                  ...
                  return (
                    n === !1
                      ? e.removeAttr(t, r)
                      : ((a = e.propFix[r] || r), a in t && (t[a] = !0), t.setAttribute(r, r.toLowerCase())),
                    r
                  )
                }
              }),
      ...
      (e.attrHooks.value = {
        get: function(e, t) {
          ...
          return 'button' === n
            ...
            : ('input' !== n && 'option' !== n && r("jQuery.fn.attr('value') no longer gets properties"),
              t in e ? e.value : null)
        },
        set: function(e, t) {
          ...
          return 'button' === a
            ...
            : ('input' !== a && 'option' !== a && r("jQuery.fn.attr('value', val) no longer sets properties"),
              (e.value = t),
              n)
        }
      })
    ...
    ;(e.fn.init = function(t, n, a) {
      ...
      return t &&
        ...
        '#' === i[0].charAt(0) &&
          (r("HTML string cannot start with a '#' character"), e.error('JQMIGRATE: Invalid selector string (XSS)')),
    ...
    e.event.props &&
      ...
      (e.event.trigger = function(e, t, n, a) {
        return (
          n || C.test(e) || r('Global events are undocumented and deprecated'), k.call(this, e, t, n || document, a)
        )
      }),
